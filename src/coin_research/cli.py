...
def main() -> None:
    ...
    markets_parser.add_argument("--limit", type=int, default=30, help="Rows to print")
    ...
    ohlcv_parser.add_argument("--limit", type=int, default=200, help="Number of candles")
    ...
    sync_parser.add_argument("--top", type=int, default=100, help="Number of market-cap assets to sync")
    sync_parser.add_argument("--symbols-limit", type=int, default=None, help="Optional symbol limit for testing")
