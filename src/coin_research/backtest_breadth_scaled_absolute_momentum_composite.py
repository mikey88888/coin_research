...
from .strategies.breadth_scaled_absolute_momentum_composite import (
...
STRATEGY_KEY = "breadth-scaled-absolute-momentum-composite"
...
def _run_id(
    *,
    ...
    return (
        ...
        f"_bsf{_decimal_slug(breadth_scale_floor_ratio)}"
    )
...
def run_backtest(
    *,
    ...
    meta = {
        ...
        "strategy_label": "Breadth-Scaled Absolute Momentum Composite",
        "engine_type": engine,
        "timeframe": timeframe,
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Backtest a breadth-scaled absolute-momentum composite prototype on crypto data")
