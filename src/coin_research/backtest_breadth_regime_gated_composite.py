...
from .strategies.breadth_regime_gated_composite import (
...
STRATEGY_KEY = "breadth-regime-gated-composite"
...
def _run_id(
    *,
    ...
    return (
        ...
        f"_br{_decimal_slug(min_breadth_ratio)}"
    )
...
def run_backtest(
    *,
    ...
    if engine == "account":
        ...
        summary["min_breadth_ratio"] = min_breadth_ratio
        ...
        summary["gated_rebalance_count"] = result.gated_rebalance_count
        summary["skipped_for_breadth_rebalance_count"] = result.skipped_for_breadth_rebalance_count
    ...
    meta = {
        ...
        "strategy_label": "Breadth Regime Gated Composite",
        "engine_type": engine,
        "timeframe": timeframe,
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Backtest a breadth-regime-gated momentum + volatility composite prototype on crypto data")
    ...
    parser.add_argument("--min-breadth-ratio", type=float, default=DEFAULT_MIN_BREADTH_RATIO)
    ...
    trade_frame, summary, run_dir, _ = run_backtest(
        ...
        min_breadth_ratio=args.min_breadth_ratio,
        symbols=symbols,
    ...
    for key in (
        ...
        "gated_rebalance_count",
        "skipped_for_breadth_rebalance_count",
        "total_return_pct",
